...
void LoadTimeConfig(int client, char[] config, char[] option)
{
    ...
    {
        g_bLoadConfig = true;
        strcopy(g_sLoadConfig, sizeof(g_sLoadConfig), config);
    }
}

public bool LoadConfig(char[] config)
{
    ...
    kv.GetString("dm_infomsg", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_infomsg.SetString(value);
    ...
    kv.GetString("dm_reset_score", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_reset_score.SetString(value);
    ...
    kv.GetString("dm_display_killfeed_player_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_killfeed_player_allow_client.SetString(value);

    kv.GetString("dm_display_damage_panel", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_panel.SetString(value);

    kv.GetString("dm_display_damage_panel_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_panel_allow_client.SetString(value);

    kv.GetString("dm_display_damage_popup", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_popup.SetString(value);

    kv.GetString("dm_display_damage_popup_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_popup_allow_client.SetString(value);

    kv.GetString("dm_display_damage_text", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_text.SetString(value);

    kv.GetString("dm_display_damage_text_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_display_damage_text_allow_client.SetString(value);

    kv.GetString("dm_sounds_bell_hit", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_hit.SetString(value);

    kv.GetString("dm_sounds_bell_hit_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_hit_allow_client.SetString(value);

    kv.GetString("dm_sounds_bell_kill", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_kill.SetString(value);

    kv.GetString("dm_sounds_bell_kill_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_kill_allow_client.SetString(value);

    kv.GetString("dm_sounds_bell_headshot", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_headshot.SetString(value);

    kv.GetString("dm_sounds_bell_headshot_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bell_headshot_allow_client.SetString(value);

    kv.GetString("dm_sounds_deaths", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_deaths.SetString(value);

    kv.GetString("dm_sounds_deaths_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_deaths_allow_client.SetString(value);

    kv.GetString("dm_sounds_bodyshots", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bodyshots.SetString(value);

    kv.GetString("dm_sounds_bodyshots_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_bodyshots_allow_client.SetString(value)

    kv.GetString("dm_sounds_headshots", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_headshots.SetString(value);

    kv.GetString("dm_sounds_headshots_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_headshots_allow_client.SetString(value);

    kv.GetString("dm_sounds_gunshots", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_gunshots.SetString(value);

    kv.GetString("dm_sounds_gunshots_allow_client", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_sounds_gunshots_allow_client.SetString(value);

    kv.GetString("dm_sounds_gunshots_distance", value, sizeof(value), "1200.0");
    g_cvDM_sounds_gunshots_distance.SetString(value);
    ...
    kv.GetString("dm_spawn_distance", value, sizeof(value), "100000.0");
    ...
    kv.GetString("dm_hp_enable", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_hp_enable.SetString(value);
    ...
    kv.GetString("dm_ap_enable", value, sizeof(value), "yes");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_ap_enable.SetString(value);
    ...
    if (!kv.JumpToKey("Preferences"))
    {
        LogError("[DM] The configuration file: %s has the following error:", path);
        LogError("[DM] The configuration file is corrupt \"Preferences\" section could not be found).");
        return false;
    }

    kv.GetString("dm_cookie_damage_panel", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_damage_panel.SetString(value);

    kv.GetString("dm_cookie_damage_popup", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_damage_popup.SetString(value);

    kv.GetString("dm_cookie_damage_text", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_damage_text.SetString(value);

    kv.GetString("dm_cookie_killfeed", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_killfeed.SetString(value);

    kv.GetString("dm_cookie_sounds_death", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_sounds_death.SetString(value);

    kv.GetString("dm_cookie_sounds_gunshots", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_sounds_gunshots.SetString(value);

    kv.GetString("dm_cookie_sounds_bodyshots", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_sounds_bodyshots.SetString(value);

    kv.GetString("dm_cookie_sounds_headshots", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_sounds_headshots.SetString(value);

    kv.GetString("dm_cookie_headshot_only", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_headshot_only.SetString(value);

    kv.GetString("dm_cookie_bell_hit", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_bell_hit.SetString(value);

    kv.GetString("dm_cookie_bell_kill", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_bell_kill.SetString(value);

    kv.GetString("dm_cookie_bell_headshot", value, sizeof(value), "no");
    value = (strcmp(value, "yes") == 0) ? "1" : "0";
    g_cvDM_cookie_bell_headshot.SetString(value);
    ...
    {
        LogError("[DM] The configuration file: %s has the following error:", path);
        LogError("[DM] The configuration file is corrupt \"Equipment\" section could not be found).");
        return false;
    }
    ...
    if (kv.GotoFirstSubKey(false))
    {
        do {
            ...
            int team = 0;
            if (strcmp(value, "CT", false) == 0)
                team = CS_TEAM_CT;
            else if (strcmp(value, "T", false) == 0)
                team = CS_TEAM_T;
    ...
    CPrintToChatAll("%t Loaded {purple}%s{default} mode.", "Chat Tag", buffer);

    delete kv;
    return true;
}

public bool LoadConfigName(char[] config)
{
    KeyValues kv = new KeyValues("Deathmatch Config");
    char path[PLATFORM_MAX_PATH];
    char buffer[PLATFORM_MAX_PATH];
    ...
    strcopy(g_sLoadConfigName, sizeof(g_sLoadConfigName), value);
...
public bool LoadMapConfig()
{
    ...
    if (file != null)
    {
        ...
        while (!file.EndOfFile() && file.ReadLine(buffer, sizeof(buffer)))
        {
            ...
            PrintToServer("#%i | Location = %f %f %f | Direction = %f %f %f", g_iSpawnPointCount, g_fSpawnPositions[g_iSpawnPointCount][0], g_fSpawnPositions[g_iSpawnPointCount][1], g_fSpawnPositions[g_iSpawnPointCount][2], g_fSpawnAngles[g_iSpawnPointCount][0], g_fSpawnAngles[g_iSpawnPointCount][1], g_fSpawnAngles[g_iSpawnPointCount][2]);
            g_iSpawnPointCount++;
        }
        PrintToServer("******************************************************");
        PrintToServer("Total Spawn Count = %i", g_iSpawnPointCount);
        PrintToServer("******************************************************");
    }
    else
    {
...
public bool CheckDirectory(char path[PLATFORM_MAX_PATH])
{
    if (!DirExists(path))
    {
